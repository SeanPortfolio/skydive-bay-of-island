...
HTML;
			...
			$posts_view .= <<<HTML
				<article class="article__row rounded__border">
				 	...
				 	<div class="article__row__content">
						...
						<p class="article__btn-outer"><a href="{$pg_full_url}{$post['full_url']}" title="{$post['title']}" class="btn btn__red">Read More</a></p>
				 	</div>				
				</article>
HTML;
		}
