		...
		if( opts.initSlick === true ) {
			...
			$(opts.galleryElmSel).on('init', function(event, slick){
				...
				slidesToShow: 3,
  				slidesToScroll: 3,
  				arrows: true,
  				prevArrow:'<div class="instagram__nav instagram__nav--prev"><i class="fas fa-angle-left"></i></div>',
            	nextArrow:'<div class="instagram__nav instagram__nav--next"><i class="fas fa-angle-right"></i></div>',
  				responsive: [
  					{
						breakpoint: 320,
						settings: {
