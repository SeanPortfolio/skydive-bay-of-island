...
function edit_item()
{
    ...
    $sql = "SELECT `person_name`, `person_location`, `description`, `photo_path`,
...
$settings_content = <<< HTML
    <table width="100%" border="0" cellspacing="0" cellpadding="8">
        ...
        <tr style="display: none;">
            <td width="130"><label for="photo_path">Photo:</label></td>
            <td>
                <input name="photo_path" type="text" value="$photo_path" style="width:250px;" data-thumb-elm="#page_thumb_photo" id="photo" readonly autocomplete="off">
