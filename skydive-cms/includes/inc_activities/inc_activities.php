...
function do_main(){
    ...
    $main_heading = 'Activities Pricing Items';
    ...
    function generate_item_list($parent_id = 0)
    {
        ...
        $sql = "SELECT ac.`id`, 
                ...
                FROM
                  `activities` ac
                LEFT JOIN `page_meta_data` pmd ON(pmd.`id` = ac.`page_meta_data_id`)
                WHERE pmd.`status` != 'D'
            ...
            foreach ($rows as $index => $row)
            {
                ...
                <tr>
                    ...
                    <td style="padding-left:{$indentation}px;">
                        <input type="hidden" name="testm_id[]" value="$meta_data_id">
...
HTML;
    ...
    $page_functions = <<< HTML
        <ul class="page-action">
            ...
            <li><button type="button" class="btn btn-default" onclick="submitForm('new',1)"><i class="glyphicon glyphicon-plus"></i> New</button></li>
