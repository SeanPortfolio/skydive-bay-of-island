...
function edit_item()
{
    ...
    $sql = "SELECT `question`, `answer` FROM `faq` WHERE `id` = '{$id}' LIMIT 1";
...
$settings_content = <<< HTML
    <table width="100%" border="0" cellspacing="0" cellpadding="8">
        ...
        <tr>
            <td width="130"><label for="question">Question:</label></td>
            <td><input name="question" type="text" id="question" value="$question" style="width:718px;" /></td>
        </tr>
        <tr>
            <td width="130" valign="top"><label for="answer">Answer:</label></td>
            <td valign="top">
                <textarea name="answer" id="answer" style="width:718px;min-height:200px;">$answer</textarea>
            </td>
        </tr>
    </table>
HTML;
