...
HTML;
    ...
    $sql = "SELECT `full_path`, `thumb_path`, `caption_heading`, `caption`, `alt_text`, `rank`
        FROM `photo`
    ...
    $photolist .= '<ul id="photos" class="slides">';
    if(!empty($result)) {     
                    ...
                    <div class="to-left padded">
                        <ul>
                            ...
                            <li>
                                ...
                                <input type="text" maxlength="150" id="caption-$photocount" name="photo_caption[]" value="$caption" class="input-xxlrg">
                            </li>
                            <li>
                                <label for="photo-alt-$photocount">Alt text:</label>
                                <input type="text" maxlength="150" id="photo-alt-$photocount" name="photo_alt[]" value="$alt_text" class="input-xxlrg">
                            </li>
                            <li>
                            ...
                            var newSlide = '<li id="photo_'+num+'">\
                                ...
                                <div class="to-left padded">\
                                    ...
                                    <li>\
                                        ...
                                        <input type="text" id="caption-'+num+'" maxlength="150" name="photo_caption[]" value="" class="input-xxlrg">\
                                    </li>\
                                        <li>\
                                            <label for="photo-alt-'+num+'">Alt text:</label>\
                                            <input type="text" id="photo-alt-'+num+'" maxlength="150" name="photo_alt[]" value="" class="input-xxlrg">\
                                        </li>\
                                        <li>\
