...
HTML;
    ...
    $photos = fetch_all("SELECT `full_path`, `thumb_path`, `rank`, `video_id`, `caption`, `alt_text` 
        FROM `photo`
                    ...
                    <div class="to-left padded">
                        <ul>
                            <li>
                                ...
                                <input type="text" maxlength="150" id="pg-photo-video-url-{$photocount}" name="photo-video-id[]" value="{$videoId}" class="input-lrg">
                            </li>
                            <li>
                                <label for="caption-$photocount">Caption:</label>
                                <input type="text" maxlength="150" id="caption-$photocount" name="photo-caption[]" value="$caption" class="input-xxlrg">
                            </li>
                            <li>
                                <label for="photo-alt-$photocount">Alt text:</label>
                                <input type="text" maxlength="150" id="photo-alt-$photocount" name="photo-alt[]" value="$altText" class="input-xxlrg">
                            </li>
                            <li>
                                <label for="rank-$photocount">Rank:</label>
                                <input type="text" id="rank-$photocount" name="photo-rank[]" value="{$rank}" class="input-small">
                                <a href="javascript:;" class="remove-photo">remove</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="to-left padded">\
                                    <ul>\
                                        <li>\
                                            ...
                                            <input type="text" maxlength="150" id="photo-video-id-'+num+'" name="photo-video-id[]" value="" class="input-xxlrg">\
                                        </li>\
                                        <li>\
                                            <label for="caption-'+num+'">Caption:</label>\
                                            <input type="text" id="caption-'+num+'" maxlength="150" name="photo-caption[]" value="" class="input-xxlrg">\
                                        </li>\
                                        <li>\
                                            <label for="photo-alt-'+num+'">Alt text:</label>\
                                            <input type="text" id="photo-alt-'+num+'" maxlength="150" name="photo-alt[]" value="" class="input-xxlrg">\
                                        </li>\
                                        <li>\
                                            <label for="rank-'+num+'" >Rank:</label>\
                                            <input type="text" name="photo-rank[]" value="" class="input-small">\
                                            <a href="javascript:;" class="remove-photo">remove</a>\
                                        </li>\
                                    </ul>\
                                </div>\
